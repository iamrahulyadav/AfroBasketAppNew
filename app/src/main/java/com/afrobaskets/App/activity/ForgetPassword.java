...
import com.webistrasoft.org.ecommerce.databinding.ForgetpasswordBinding;
...
public class ForgetPassword extends AppCompatActivity {
    ...
    private void forgetPassword(){
        ...
        String old_pass = forgetpasswordBinding.email.getText().toString();
             if (!Constants.isEmpty(old_pass)) {
            forgetpasswordBinding.email.setError("Enter password");
            return;
        }
...
finish();
                            ...
                            else
                            {
                                ...
                                Constants.showSnackBar(ForgetPassword.this,jObject.getString("msg"));
                            }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof TimeoutError || error instanceof NoConnectionError) {
                    Constants.showSnackBar(ForgetPassword.this,"Communication Error!");
                } else if (error instanceof AuthFailureError) {
                    Constants.showSnackBar(ForgetPassword.this, "Authentication Error!");
                } else if (error instanceof ServerError) {
                    Constants.showSnackBar(ForgetPassword.this,"Server Side Error!");
                } else if (error instanceof NetworkError) {
                    Constants.showSnackBar(ForgetPassword.this, "Network Error!");
                } else if (error instanceof ParseError) {
                    Constants.showSnackBar(ForgetPassword.this,"Parse Error!");
                }
