...
import com.afrobaskets.App.activity.ReorderActivity;
...
*/
    ...
    public PreviousOrderAdapter(Context context, List<CartBean> foodList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.previousorderadapter, parent, false);
